...
Example: BUFFER_SEARCH(ADR(aArray), SIZEOF(Array), 'FIND', 0, TRUE) Locates 'FIND', 'Find', 'find' .... in the array. Example: BUFFER_SEARCH(ADR(Array), SIZEOF(ARRAY), 'FIND', 0, FALSE) Only finds 'FIND' in the array.
