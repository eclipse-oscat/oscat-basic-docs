...
![csv_parser_file](csv_parser_file.gif)

**Beispiel:**

Example 1 evaluate Text file line by line: Zeile 1<CR,LF>
...
RUN set back to 1 
VALUE = '', RUN = 0 , RESULT = 10 If the file access is no longer needed, the user must close the file be either by use of AUTO_CLOSE or MODE 5 (close file) of the FILE_SERVER. RUN: Feature List RESULT: Result - Feedback
