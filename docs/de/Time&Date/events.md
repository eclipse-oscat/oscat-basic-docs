...
Beispiele: (NAME := 'Gründungstag', DAY := 13, MONTH := 7, USE := 1) festes Event „Gründungstag“ am 13. Juli für einen Tag. (NAME := 'Gründungstag', DAY := 13, MONTH := 7, USE := 0) Event an einem festen Datum USE=0 bedeutet es ist nicht aktiv. (NAME := 'Betriebsurlaub', DAY := 1, MONTH := 8, USE := 31) legt ein Event mit einer Dauer von 31 Tagen fest.
