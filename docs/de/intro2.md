...
Die von OSCAT implementierte Doppelte REAL Genauigkeit hat eine Auflösung von etwa 15 Stellen. Der hierfür Implementierte Datentyp REAL2 besteht aus R1 und RX, hierbei wird in RX der Wert mir den ersten 7-8 Stellen als Real gespeichert und der Rest in einem Weiteren REAL R1. Dieser Datentyp hat den Vorteil das keine Wandlung von REAL2 zu REAL notwendig, ist, vielmehr ist der Teil RX bereits der einfache REAL Wert.
